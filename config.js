...
dotenv.config();
module.exports = {
  rest_service_host: process.env.REST_SERVICE_HOST ? process.env.REST_SERVICE_HOST : "localhost",
  ...
  user_service_host: process.env.USER_SERVICE_HOST ? process.env.USER_SERVICE_HOST : "localhost",
  ...
  bc_websocket_host: process.env.BC_WEBSOCKET_HOST ? process.env.BC_WEBSOCKET_HOST : "localhost",
